...
However, these symbols \emph{can} be used as unary predicates, if enclosed
...
so  it will perform the specialization optimization.\footnote{
  %%
  Although this optimization is the default in XSB, \FLORA turns it off
  because we believe it is buggy.
  %%
  }
...
\subsection{Permanent Production Mode}
