...
%% 
\begin{verbatim}
    flora_tracelog(CallId,CallNumber,PortType,CurrentCall,MatchingRuleList,Time)
\end{verbatim}
%% 
...
\texttt{CurrentCall} is the call being traced. \texttt{MatchingRuleList} is
a list of \FLORA rule instances whose head matches \texttt{CurrentCall}.
