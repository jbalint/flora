...
\section{Anonymous and Generated Oids, Skolem Terms}\label{sec-anon-gen-oids}
...
\paragraph{Skolems.}
A purely logical way to look at the anonymous and generated oids is to view
them as Skolem symbols. When such a symbol is a constant, it is called a
Skolem constant. If it plays the role of a function, it is then called a
Skolem function (e.g., {\tt \_\#(a,b)}). Since \FLORA terms are actually HiLog terms, we can also
...
Instead of a ``normal'' term, a rule tag can be an anonymous oid
