...
quasi-constant
\texttt{\_@!}. This quasi-constant gets replaced by the Id of the rule where
the quasi-constant occurs. The replacement happens at compile time for the static
...
descriptors---only in rule descriptor queries---because they are assigned
