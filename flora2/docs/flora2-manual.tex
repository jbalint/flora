...
%% 
\begin{alltt}
   ./confflora  \textnormal{\emph{path-for-/XSB/bin/xsb}}
\end{alltt}
%% 
...
%% 
\begin{alltt}
   confflora  \textnormal{\emph{path-for-{\ensuremath\backslash}XSB{\ensuremath\backslash}bin{\ensuremath\backslash}xsb.bat}}
\end{alltt}
%% 
or
%% 
\begin{alltt}
   confflora  \textnormal{\emph{path-for-{\ensuremath\backslash}XSB{\ensuremath\backslash}bin{\ensuremath\backslash}xsb64.bat}}
\end{alltt}
%% 
