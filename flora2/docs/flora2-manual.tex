...
The script to run \FLSYSTEM is \texttt{\textbf{DIR}/flora2/runflora}.  
...
The command to run \FLSYSTEM is \texttt{./runflora} (Linux/Mac/Cygwin)
or \texttt{runflora.bat} (Windows). These scripts are located in the
