...
\begin{itemize}
  \index{quasi-constant}
  \index{\_\# quasi-constant}
  \index{\_\#1, \_\#2, etc., quasi-constant}
  \index{\_!@ quasi-constant}
  \index{\_@ quasi-constant}
  \index{\_@F quasi-constant}
  \index{\_@L quasi-constant}
...
\begin{itemize}
  \index{quasi-variable}
  \index{\_?C quasi-variable}
  \index{\_?F quasi-variable}
  \index{\_?L quasi-variable}
...
quasi-constants \verb|_#| and \verb|_#1|, \verb|_#2|, etc.,
...
\end{verbatim}
%%
(The quasi-constants \texttt{\_@F}, \texttt{\_@}, and others
...
\end{verbatim}
%% 
However, one must keep in mind that \texttt{\_@F} occurring 
in the \FLSYSTEM shell is
different from \texttt{\_@F} occurring in a file
