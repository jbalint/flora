...
\end{itemize}
%% 
Note that the rules that are inserted via an \texttt{insert\{...\}} or
\texttt{insertrule\{...\}}  statement do not have a natural file name to
use, so \texttt{'(dynrule)'} is used in this case. 
...
and its module. For dynamic rules, the file name is \texttt{'(dynrule)'}.
The following
