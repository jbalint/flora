...
\subsection{Quasi-constants and Quasi-variables}
...
\item  \texttt{\_@} -- the module into which the file containing this
  quasi-constant is loaded.
\item \texttt{\_@F} -- the file in which this quasi-constant occurs.
...
part use \texttt{\_@} --- the quasi-constants introduced earlier. 
