...
\item {\tt compile\{file>{}>module\}}:
    Compile FILE.\flrext for the module {\tt module}.
  \item {\tt load\{file>{}>module\}}: Load {\tt file.\flrext} into the module {\tt
      module}. If you specify {\tt file.P} or {\tt file.\ofile} then will load
    these files.
  \item {\tt load\{file\}}: Load {\tt file.\flrext} into the default module {\tt
...
\item {\tt compileadd\{file>{}>module\}}:
    Compile FILE.\flrext for adding to the module {\tt module}.
  \item {\tt add\{file>{}>module\}}: Add {\tt file.\flrext} to the module {\tt
      module}.
  \item {\tt add\{file\}}: Add {\tt file.\flrext} to the default module {\tt
      main}. 
...
%%
\index{{\tt '\bs{}\bs{}load'/1} predicate}
\index{{\tt '\bs{}\bs{}compile''/1} predicate}
\begin{quote}
 \tt
...
the file \texttt{file.\flrext} uses those functions, then it is necessary to
tell \FLSYSTEM \emph{in the file}   \texttt{file.\flrext} that these are UDFs and not regular HiLog
...
will issue an error at loading time.\footnote{
  ...
  cannot know in advance that \texttt{file.\flrext} is intended to
