...
The official releases of \FLORA, starting with version 0.99.3, also include
...
This procedure is much more complex than the one for installing the
official \FLORA releases described above. It is suitable for the users who
need the very latest development version of \FLORA---either in order to
obtain the very latest bug fixes or to try the new cutting-edge features.
...
XSB sources must be installed. If you used the XSB Windows installer,
