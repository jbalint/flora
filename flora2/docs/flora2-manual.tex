...
\end{verbatim}
%% 
In addition, the type property can be used to find out whether a particular
annotated statement is a rule or an integrity constraint:
%% 
\begin{verbatim}
...
\texttt{rule}; if it is an integrity constraint then this variable gets
bound to \texttt{ic}.   
