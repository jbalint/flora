...
dynamic_data.dat: dynamic_data.in
	"$(PROLOG)" -e "asserta(library_directory('..')). ['..\\flora2']. import '_#flmakesetup'/0 from flora2. '_#flmakesetup'. [flrwraparound]. import flrWrapAround/1 from flrwraparound. flWrapAround(%|fF). halt.
